...
def make_character(starting_stats):
    """
    Makes a character
    ...
    :return: a dictionary
    """
    new_player = {"X-coordinate": starting_stats[0], "Y-coordinate": starting_stats[1], "HP": starting_stats[2]}
    return new_player
